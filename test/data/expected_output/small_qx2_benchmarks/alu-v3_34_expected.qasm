...
t q[4]; //cycle: 41 //t q[0]
cx q[3],q[4]; //cycle: 42 //cx q[3],q[0]
t q[2]; //cycle: 42 //t q[2]
cx q[1],q[0]; //cycle: 44 //cx q[4],q[1]
cx q[2],q[3]; //cycle: 44 //cx q[2],q[3]
cx q[4],q[2]; //cycle: 46 //cx q[0],q[2]
tdg q[3]; //cycle: 46 //tdg q[3]
cx q[4],q[3]; //cycle: 48 //cx q[0],q[3]
t q[2]; //cycle: 48 //t q[2]
tdg q[4]; //cycle: 50 //tdg q[0]
tdg q[3]; //cycle: 50 //tdg q[3]
cx q[2],q[3]; //cycle: 51 //cx q[2],q[3]
cx q[4],q[2]; //cycle: 53 //cx q[0],q[2]
cx q[3],q[4]; //cycle: 55 //cx q[3],q[0]
h q[2]; //cycle: 55 //h q[2]
cx q[2],q[3]; //cycle: 57 //cx q[2],q[3]
//52 original gates
//54 gates in generated circuit
//53 ideal depth (cycles)
//59 depth of generated circuit
//2992 nodes popped from queue for processing.
//3119 nodes remain in queue.
//HashFilter filtered 2980 total nodes.
//HashFilter2 filtered 1383 total nodes.
//HashFilter2 marked 1991 total nodes.
