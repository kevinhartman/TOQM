...
cx q[1],q[2]; //cycle: 83 //cx q[3],q[0]
tdg q[10]; //cycle: 85 //tdg q[6]
tdg q[5]; //cycle: 85 //tdg q[5]
cx q[1],q[7]; //cycle: 85 //cx q[3],q[4]
t q[2]; //cycle: 85 //t q[0]
cx q[6],q[5]; //cycle: 86 //cx q[1],q[5]
tdg q[1]; //cycle: 87 //tdg q[3]
tdg q[7]; //cycle: 87 //tdg q[4]
cx q[10],q[6]; //cycle: 88 //cx q[6],q[1]
cx q[2],q[7]; //cycle: 88 //cx q[0],q[4]
cx q[5],q[10]; //cycle: 90 //cx q[5],q[6]
h q[6]; //cycle: 90 //h q[1]
cx q[1],q[2]; //cycle: 90 //cx q[3],q[0]
h q[6]; //cycle: 91 //h q[1]
t q[10]; //cycle: 92 //t q[6]
t q[6]; //cycle: 92 //t q[1]
x q[5]; //cycle: 92 //x q[5]
cx q[7],q[1]; //cycle: 92 //cx q[4],q[3]
h q[2]; //cycle: 92 //h q[0]
t q[5]; //cycle: 93 //t q[5]
h q[2]; //cycle: 93 //h q[0]
h q[7]; //cycle: 94 //h q[4]
cx q[11],q[5]; //cycle: 94 //cx q[2],q[5]
t q[1]; //cycle: 94 //t q[3]
t q[2]; //cycle: 94 //t q[0]
t q[7]; //cycle: 95 //t q[4]
...
cx q[5],q[0]; //cycle: 534 //cx q[5],q[3]
cx q[6],q[5]; //cycle: 536 //cx q[2],q[5]
h q[0]; //cycle: 536 //h q[3]
h q[0]; //cycle: 537 //h q[3]
h q[6]; //cycle: 538 //h q[2]
t q[5]; //cycle: 538 //t q[5]
t q[0]; //cycle: 538 //t q[3]
t q[6]; //cycle: 539 //t q[2]
cx q[6],q[1]; //cycle: 540 //cx q[2],q[6]
cx q[11],q[6]; //cycle: 542 //cx q[7],q[2]
tdg q[1]; //cycle: 542 //tdg q[6]
t q[6]; //cycle: 544 //t q[2]
swp q[1],q[6]; //cycle: 545
cx q[11],q[6]; //cycle: 551 //cx q[7],q[6]
tdg q[11]; //cycle: 553 //tdg q[7]
tdg q[6]; //cycle: 553 //tdg q[6]
cx q[1],q[6]; //cycle: 554 //cx q[2],q[6]
swp q[1],q[6]; //cycle: 556
cx q[11],q[6]; //cycle: 562 //cx q[7],q[2]
h q[6]; //cycle: 564 //h q[2]
t q[6]; //cycle: 565 //t q[2]
cx q[6],q[5]; //cycle: 566 //cx q[2],q[5]
swp q[1],q[6]; //cycle: 568
cx q[6],q[11]; //cycle: 574 //cx q[6],q[7]
cx q[0],q[1]; //cycle: 574 //cx q[3],q[2]
cx q[5],q[0]; //cycle: 576 //cx q[5],q[3]
tdg q[1]; //cycle: 576 //tdg q[2]
t q[11]; //cycle: 576 //t q[7]
t q[6]; //cycle: 576 //t q[6]
cx q[6],q[11]; //cycle: 577 //cx q[6],q[7]
t q[0]; //cycle: 578 //t q[3]
swp q[0],q[1]; //cycle: 579
cx q[5],q[0]; //cycle: 585 //cx q[5],q[2]
tdg q[5]; //cycle: 587 //tdg q[5]
tdg q[0]; //cycle: 587 //tdg q[2]
cx q[1],q[0]; //cycle: 588 //cx q[3],q[2]
swp q[5],q[6]; //cycle: 589
cx q[6],q[1]; //cycle: 595 //cx q[5],q[3]
swp q[0],q[5]; //cycle: 597
h q[1]; //cycle: 597 //h q[3]
t q[1]; //cycle: 598 //t q[3]
cx q[1],q[7]; //cycle: 599 //cx q[3],q[4]
cx q[2],q[1]; //cycle: 601 //cx q[0],q[3]
cx q[5],q[6]; //cycle: 603 //cx q[2],q[5]
cx q[7],q[2]; //cycle: 603 //cx q[4],q[0]
tdg q[1]; //cycle: 603 //tdg q[3]
cx q[7],q[1]; //cycle: 605 //cx q[4],q[3]
t q[2]; //cycle: 605 //t q[0]
t q[6]; //cycle: 605 //t q[5]
t q[5]; //cycle: 605 //t q[2]
cx q[5],q[6]; //cycle: 606 //cx q[2],q[5]
tdg q[7]; //cycle: 607 //tdg q[4]
tdg q[1]; //cycle: 607 //tdg q[3]
cx q[2],q[1]; //cycle: 608 //cx q[0],q[3]
cx q[7],q[2]; //cycle: 610 //cx q[4],q[0]
cx q[1],q[7]; //cycle: 612 //cx q[3],q[4]
h q[2]; //cycle: 612 //h q[0]
swp q[0],q[5]; //cycle: 613
h q[2]; //cycle: 613 //h q[0]
h q[1]; //cycle: 614 //h q[3]
t q[7]; //cycle: 614 //t q[4]
t q[2]; //cycle: 614 //t q[0]
t q[1]; //cycle: 615 //t q[3]
cx q[1],q[0]; //cycle: 619 //cx q[3],q[2]
cx q[6],q[1]; //cycle: 621 //cx q[5],q[3]
tdg q[0]; //cycle: 621 //tdg q[2]
swp q[5],q[6]; //cycle: 623
t q[1]; //cycle: 623 //t q[3]
cx q[5],q[0]; //cycle: 629 //cx q[5],q[2]
tdg q[5]; //cycle: 631 //tdg q[5]
tdg q[0]; //cycle: 631 //tdg q[2]
cx q[1],q[0]; //cycle: 632 //cx q[3],q[2]
swp q[0],q[5]; //cycle: 634
cx q[0],q[1]; //cycle: 640 //cx q[5],q[3]
cx q[5],q[0]; //cycle: 642 //cx q[2],q[5]
h q[1]; //cycle: 642 //h q[3]
h q[1]; //cycle: 643 //h q[3]
h q[5]; //cycle: 644 //h q[2]
t q[0]; //cycle: 644 //t q[5]
t q[1]; //cycle: 644 //t q[3]
t q[5]; //cycle: 645 //t q[2]
cx q[5],q[6]; //cycle: 646 //cx q[2],q[6]
cx q[11],q[5]; //cycle: 648 //cx q[7],q[2]
tdg q[6]; //cycle: 648 //tdg q[6]
cx q[11],q[6]; //cycle: 650 //cx q[7],q[6]
t q[5]; //cycle: 650 //t q[2]
tdg q[11]; //cycle: 652 //tdg q[7]
tdg q[6]; //cycle: 652 //tdg q[6]
cx q[5],q[6]; //cycle: 653 //cx q[2],q[6]
cx q[11],q[5]; //cycle: 655 //cx q[7],q[2]
cx q[6],q[11]; //cycle: 657 //cx q[6],q[7]
h q[5]; //cycle: 657 //h q[2]
t q[5]; //cycle: 658 //t q[2]
cx q[5],q[0]; //cycle: 659 //cx q[2],q[5]
t q[11]; //cycle: 659 //t q[7]
t q[6]; //cycle: 659 //t q[6]
cx q[6],q[11]; //cycle: 660 //cx q[6],q[7]
swp q[5],q[6]; //cycle: 662
cx q[1],q[6]; //cycle: 668 //cx q[3],q[2]
cx q[0],q[1]; //cycle: 670 //cx q[5],q[3]
tdg q[6]; //cycle: 670 //tdg q[2]
swp q[0],q[5]; //cycle: 672
t q[1]; //cycle: 672 //t q[3]
cx q[5],q[6]; //cycle: 678 //cx q[5],q[2]
tdg q[5]; //cycle: 680 //tdg q[5]
tdg q[6]; //cycle: 680 //tdg q[2]
cx q[1],q[6]; //cycle: 681 //cx q[3],q[2]
swp q[0],q[5]; //cycle: 682
cx q[0],q[1]; //cycle: 688 //cx q[5],q[3]
h q[1]; //cycle: 690 //h q[3]
swp q[5],q[6]; //cycle: 691
t q[1]; //cycle: 691 //t q[3]
cx q[7],q[1]; //cycle: 692 //cx q[4],q[3]
cx q[2],q[7]; //cycle: 694 //cx q[0],q[4]
cx q[1],q[2]; //cycle: 696 //cx q[3],q[0]
tdg q[7]; //cycle: 696 //tdg q[4]
cx q[5],q[0]; //cycle: 697 //cx q[2],q[5]
cx q[1],q[7]; //cycle: 698 //cx q[3],q[4]
t q[2]; //cycle: 698 //t q[0]
t q[0]; //cycle: 699 //t q[5]
t q[5]; //cycle: 699 //t q[2]
tdg q[1]; //cycle: 700 //tdg q[3]
tdg q[7]; //cycle: 700 //tdg q[4]
cx q[5],q[0]; //cycle: 700 //cx q[2],q[5]
cx q[2],q[7]; //cycle: 701 //cx q[0],q[4]
cx q[1],q[2]; //cycle: 703 //cx q[3],q[0]
cx q[7],q[1]; //cycle: 705 //cx q[4],q[3]
h q[2]; //cycle: 705 //h q[0]
swp q[5],q[6]; //cycle: 706
h q[2]; //cycle: 706 //h q[0]
h q[7]; //cycle: 707 //h q[4]
t q[1]; //cycle: 707 //t q[3]
t q[2]; //cycle: 707 //t q[0]
t q[7]; //cycle: 708 //t q[4]
cx q[7],q[6]; //cycle: 712 //cx q[4],q[2]
swp q[0],q[1]; //cycle: 713
tdg q[6]; //cycle: 714 //tdg q[2]
cx q[1],q[7]; //cycle: 719 //cx q[5],q[4]
cx q[1],q[6]; //cycle: 721 //cx q[5],q[2]
t q[7]; //cycle: 721 //t q[4]
tdg q[1]; //cycle: 723 //tdg q[5]
tdg q[6]; //cycle: 723 //tdg q[2]
cx q[7],q[6]; //cycle: 724 //cx q[4],q[2]
cx q[1],q[7]; //cycle: 726 //cx q[5],q[4]
cx q[6],q[1]; //cycle: 728 //cx q[2],q[5]
h q[7]; //cycle: 728 //h q[4]
h q[7]; //cycle: 729 //h q[4]
h q[6]; //cycle: 730 //h q[2]
t q[1]; //cycle: 730 //t q[5]
t q[7]; //cycle: 730 //t q[4]
t q[6]; //cycle: 731 //t q[2]
cx q[6],q[5]; //cycle: 732 //cx q[2],q[6]
cx q[11],q[6]; //cycle: 734 //cx q[7],q[2]
tdg q[5]; //cycle: 734 //tdg q[6]
cx q[11],q[5]; //cycle: 736 //cx q[7],q[6]
t q[6]; //cycle: 736 //t q[2]
tdg q[11]; //cycle: 738 //tdg q[7]
tdg q[5]; //cycle: 738 //tdg q[6]
cx q[6],q[5]; //cycle: 739 //cx q[2],q[6]
cx q[11],q[6]; //cycle: 741 //cx q[7],q[2]
cx q[5],q[11]; //cycle: 743 //cx q[6],q[7]
h q[6]; //cycle: 743 //h q[2]
t q[6]; //cycle: 744 //t q[2]
cx q[6],q[1]; //cycle: 745 //cx q[2],q[5]
t q[11]; //cycle: 745 //t q[7]
t q[5]; //cycle: 745 //t q[6]
cx q[5],q[11]; //cycle: 746 //cx q[6],q[7]
cx q[7],q[6]; //cycle: 747 //cx q[4],q[2]
cx q[1],q[7]; //cycle: 749 //cx q[5],q[4]
tdg q[6]; //cycle: 749 //tdg q[2]
cx q[1],q[6]; //cycle: 751 //cx q[5],q[2]
t q[7]; //cycle: 751 //t q[4]
tdg q[1]; //cycle: 753 //tdg q[5]
tdg q[6]; //cycle: 753 //tdg q[2]
cx q[7],q[6]; //cycle: 754 //cx q[4],q[2]
cx q[1],q[7]; //cycle: 756 //cx q[5],q[4]
cx q[6],q[1]; //cycle: 758 //cx q[2],q[5]
h q[7]; //cycle: 758 //h q[4]
t q[7]; //cycle: 759 //t q[4]
t q[1]; //cycle: 760 //t q[5]
t q[6]; //cycle: 760 //t q[2]
cx q[6],q[1]; //cycle: 761 //cx q[2],q[5]
swp q[0],q[1]; //cycle: 763
cx q[7],q[1]; //cycle: 769 //cx q[4],q[3]
cx q[2],q[7]; //cycle: 771 //cx q[0],q[4]
cx q[1],q[2]; //cycle: 773 //cx q[3],q[0]
tdg q[7]; //cycle: 773 //tdg q[4]
cx q[1],q[7]; //cycle: 775 //cx q[3],q[4]
t q[2]; //cycle: 775 //t q[0]
tdg q[1]; //cycle: 777 //tdg q[3]
tdg q[7]; //cycle: 777 //tdg q[4]
cx q[2],q[7]; //cycle: 778 //cx q[0],q[4]
cx q[1],q[2]; //cycle: 780 //cx q[3],q[0]
cx q[7],q[1]; //cycle: 782 //cx q[4],q[3]
h q[2]; //cycle: 782 //h q[0]
h q[7]; //cycle: 784 //h q[4]
t q[7]; //cycle: 785 //t q[4]
cx q[7],q[6]; //cycle: 786 //cx q[4],q[2]
swp q[0],q[1]; //cycle: 787
tdg q[6]; //cycle: 788 //tdg q[2]
cx q[1],q[7]; //cycle: 793 //cx q[5],q[4]
cx q[1],q[6]; //cycle: 795 //cx q[5],q[2]
t q[7]; //cycle: 795 //t q[4]
tdg q[1]; //cycle: 797 //tdg q[5]
tdg q[6]; //cycle: 797 //tdg q[2]
cx q[7],q[6]; //cycle: 798 //cx q[4],q[2]
cx q[1],q[7]; //cycle: 800 //cx q[5],q[4]
cx q[6],q[1]; //cycle: 802 //cx q[2],q[5]
h q[7]; //cycle: 802 //h q[4]
h q[7]; //cycle: 803 //h q[4]
h q[6]; //cycle: 804 //h q[2]
t q[1]; //cycle: 804 //t q[5]
t q[7]; //cycle: 804 //t q[4]
t q[6]; //cycle: 805 //t q[2]
cx q[6],q[5]; //cycle: 806 //cx q[2],q[6]
cx q[11],q[6]; //cycle: 808 //cx q[7],q[2]
tdg q[5]; //cycle: 808 //tdg q[6]
cx q[11],q[5]; //cycle: 810 //cx q[7],q[6]
t q[6]; //cycle: 810 //t q[2]
tdg q[11]; //cycle: 812 //tdg q[7]
tdg q[5]; //cycle: 812 //tdg q[6]
cx q[6],q[5]; //cycle: 813 //cx q[2],q[6]
cx q[11],q[6]; //cycle: 815 //cx q[7],q[2]
cx q[5],q[11]; //cycle: 817 //cx q[6],q[7]
h q[6]; //cycle: 817 //h q[2]
t q[6]; //cycle: 818 //t q[2]
cx q[6],q[1]; //cycle: 819 //cx q[2],q[5]
cx q[7],q[6]; //cycle: 821 //cx q[4],q[2]
cx q[1],q[7]; //cycle: 823 //cx q[5],q[4]
tdg q[6]; //cycle: 823 //tdg q[2]
cx q[1],q[6]; //cycle: 825 //cx q[5],q[2]
t q[7]; //cycle: 825 //t q[4]
tdg q[1]; //cycle: 827 //tdg q[5]
tdg q[6]; //cycle: 827 //tdg q[2]
cx q[7],q[6]; //cycle: 828 //cx q[4],q[2]
cx q[1],q[7]; //cycle: 830 //cx q[5],q[4]
cx q[6],q[1]; //cycle: 832 //cx q[2],q[5]
h q[7]; //cycle: 832 //h q[4]
//650 original gates
//705 gates in generated circuit
//571 ideal depth (cycles)
//834 depth of generated circuit
//638573 nodes popped from queue for processing.
//1039 nodes remain in queue.
